...
data = pd.read_csv('C:\LaLaLa\Data_Storage\FastFoodNutritionMenuV2.csv')

sever = 'KHANHTUONGDEPTR\SQLEXPRESS'
datatabase ='FASTFOOD'
...
cnxn = pyodbc.connect('DRIVER={ODBC Driver 11 for SQL Server};SERVER='+sever+';DATABASE='+datatabase+';Trusted_Connection=yes;')
